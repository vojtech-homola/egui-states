...
class StateServerCore:
    ...
    # add states ------------------------------------------------------------------
    def add_value(self, value_id: int, type_id: int, object_type: PyObjectType, initial_value: object) -> None: ...
    def add_static(self, value_id: int, type_id: int, object_type: PyObjectType, initial_value: object) -> None: ...
    def add_signal(self, value_id: int, type_id: int, object_type: PyObjectType) -> None: ...
    def add_list(self, value_id: int, type_id: int, object_type: PyObjectType) -> None: ...
    def add_map(self, value_id: int, type_id: int, key_type: PyObjectType, value_type: PyObjectType) -> None: ...
    def add_image(self, value_id: int) -> None: ...
    def add_graphs(self, value_id: int, is_double: bool) -> None: ...
