...
class SteteServerCoreBase:
    ...
    # image -----------------------------------------------------------------------
    def image_set(self, value_id: int, image: Buffer, update: bool, rect: list[int] | None = None) -> None: ...
    def histogram_set(self, value_id: int, update: bool, histogram: Buffer | None = None) -> None: ...
    ...
    # graphs ----------------------------------------------------------------------
    def graphs_set(
        self, value_id: int, idx: int, graph: Buffer, update: bool, range: tuple[float, float] | None = None
    ) -> None: ...
    def graphs_get(self, value_id: int, idx: int) -> tuple[bytes, tuple[int, ...], tuple[float, float] | None]: ...
    def graphs_add_points(
        self, value_id: int, idx: int, points: Buffer, update: bool, range: tuple[float, float] | None
    ) -> None: ...
    def graphs_remove(self, value_id: int, idx: int, update: bool) -> None: ...
    def graphs_len(self, value_id: int) -> int: ...
